package com.hatchetstudios.engine.graphics.engine;
...
import com.hatchetstudios.engine.graphics.tiles.FloorTile;
import com.hatchetstudios.engine.graphics.tiles.WallTile;
import com.hatchetstudios.entities.Alavanca;
...
import com.hatchetstudios.entities.Poco;
import com.hatchetstudios.entities.Princesa;
import com.hatchetstudios.entities.Vaso;
import com.hatchetstudios.events.eventBlock;
...
public class World {
	...
	public void loadEntities() {
		...
		placaDialogue_SECOND[0].add("Esse cap�tulo fala sobre magias que conseguem");
		placaDialogue_SECOND[0].add("deixar itens invis�veis. Mas s� at� alg�m tocar neles.");
		placaDialogue_SECOND[1].add("Cap�tulo 2");
		placaDialogue_SECOND[1].add("Nesse cap�tulo explica passo a passo como");
		placaDialogue_SECOND[1].add("voc� pode energizar qualquer grade de metal");
		...
		placaDialogo[1].add("Hum... Nem era t�o negra assim.");
		...
		Game.entities.add(new eventBlock(272, 480, Tile.SIZE, Tile.SIZE, null, true, "chave4", "Chave do Por�o",
